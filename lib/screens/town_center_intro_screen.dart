...
import 'town_center_sort_transition_screen.dart';
...
/// Town Center intro: zoom into polluted plaza, Mayor and a child citizen.
class TownCenterIntroScreen extends StatefulWidget {
  const TownCenterIntroScreen({
    super.key,
  ...
  @override
  State<TownCenterIntroScreen> createState() => _TownCenterIntroScreenState();
}

class _TownCenterIntroScreenState extends State<TownCenterIntroScreen>
    with TickerProviderStateMixin {
  static const Color _mayorAccent = Color(0xFF3949AB);
  static const Color _childAccent = Color(0xFFFFB300);
  ...
  static const List<_Line> _lines = <_Line>[
    ...
    _Line(
      'Mayor',
      _mayorAccent,
      "Because of your efforts, our park, school, neighborhood, and beach have been restored.",
      isMayor: true,
    ),
    _Line(
      'Mayor',
    ...
    _Line(
      'Child',
      _childAccent,
      'Can we finally have our beautiful town back?',
      isChild: true,
    ),
    _Line(
      'Mayor',
  ...
  late final AnimationController _childIn = AnimationController(
    vsync: this,
    duration: const Duration(milliseconds: 750),
  );
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute<void>(
        builder: (BuildContext context) => PuzzleScreen(
          ...
          imageAsset: GameProgress.townCenterPuzzleClean,
          itemName: 'Restored Green Town',
          gridSize: 5,
          backgroundAsset: GameProgress.townCenterTrashBg,
          phaseLabel: 'Level 9 · Phase 1',
          instructionText:
              'Complete the picture to see the future of Green Town.',
          completeMessage: "Now let's make this vision a reality.",
          nextBuilder: (BuildContext context) =>
              TownCenterSortTransitionScreen(
            character: widget.character,
            location: widget.location,
          ),
        ),
  ...
  bool get _showingChild =>
      _lineIndex >= 0 && _lines[_lineIndex].isChild;
                    ...
                    child: AnimatedBuilder(
                      ...
                      builder: (BuildContext context, Widget? child) {
                        ...
                        final double opacity = compact
                            ...
                            : (0.12 + _zoom.value).clamp(0.0, 1.0);
                ...
                if (!compact) ...<Widget>[
                    ...
                    AnimatedBuilder(
                      ...
                      builder: (BuildContext context, Widget? child) {
                        ...
                        return Positioned(
                          ...
                          height: spriteHeight,
                          child: Opacity(
                            opacity: t * (_showingChild ? 0.5 : 1.0),
                            child: child,
                          ),
                        );
                      },
                  ...
                  if (_childArrived)
                    AnimatedBuilder(
                      ...
                      builder: (BuildContext context, Widget? child) {
                        final double t =
                            Curves.easeOut.transform(_childIn.value);
                        return Positioned(
                          bottom: 0 - (1 - t) * 36,
                          right: w * 0.04,
...
class _MobileChildStack extends StatelessWidget {
  const _MobileChildStack({
    required this.width,
    required this.text,
